...
const ContractTokenIdBlock = (prop) => {
    ...
    return (
        <>
            <div className='ContractTokenIdBlock'>
                {loaded || <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" style={{margin: 'auto', background: 'none', display: 'block', shapeRendering: 'auto', width:"200px", height:"200px", preserveAspectRatio:"xMidYMid"}} viewBox="0 0 100 100">
